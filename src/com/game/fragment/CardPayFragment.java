...
public class CardPayFragment extends Fragment {
	...
	private void initView(View view) {
		...
		edit_cardno = (EditText) view.findViewById(ResourceUtil.getId(
				getActivity(), "edit_cardnum_fragment"));
		edit_cardkey = (EditText) view.findViewById(ResourceUtil.getId(
				getActivity(), "edit_cardpass_fragment"));

		zhifu = (Button) view.findViewById(ResourceUtil.getId(getActivity(),
		...
		spinner = (Spinner) view.findViewById(ResourceUtil.getId(getActivity(),
		...
		TextView textView = (TextView) view.findViewById(ResourceUtil.getId(
				getActivity(), "payname_table_fragment_card"));
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(getActivity())
						.inflate(
								ResourceUtil.getLayoutId(getActivity(),
										"item_spinner"), null);
